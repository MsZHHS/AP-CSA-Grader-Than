/**
 * PictureExplorer.java  12/28/2012
 *
...
/**
 * Displays a picture and lets you explore the picture by displaying
 * the row, column, red, green, and blue values of the pixel at the cursor
 * when you click a mouse button or press and hold a mouse button while
 * moving the cursor.  It also lets you zoom in or out.  You can also type
	...
	implements MouseMotionListener, ActionListener, MouseListener
{
	...
	private void setUpNextAndPreviousButtons()
	{
		...
		Icon prevIcon = new ImageIcon(
			DigitalPicture.class.getResource("leftArrow.gif"), "previous index");
	...
	public void checkScroll()
	{
		...
		if (zoomFactor > 1)
		{
			...
			int macolIndexX =
				(int)(picture.getWidth() * zoomFactor) - rectWidth - 1;
			int macolIndexY =
				(int)(picture.getHeight() * zoomFactor) - rectHeight - 1;
	...
	public void displayPixelInformation(String xString, String yString)
	{
		...
		{
			boolean ignore = true; // Silly statement to placate Checkstyle
		}
